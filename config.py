...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "7988129609:AAG8foCpNk5qOMhWMBGRT7q_8wXWFFdYMPg")
...
FORCE_SUB_CHANNEL_1 = int(os.environ.get("FORCE_SUB_CHANNEL_1", "-1001646925412"))
